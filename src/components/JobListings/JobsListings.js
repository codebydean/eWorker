                ...
                <div id='navigation' className='flex flex-col flex-1 px-4 mt-1'>
                    <div className='space-y-4'>
                        <nav id='main-menu' className='flex-1 space-y-2 translate-y-[-5rem]'>
                            ...
                            <NavLink to="/Dashboard" className='w-full flex items-center px-4 py-2.5 text-lg font-bold text-[#067FB9] hover:bg-[#067FB9] hover:text-white rounded-xl focus:bg-[#067FB9] focus:text-white transition-all duration-200 group '>
                                <FontAwesomeIcon icon={faHouse} className='h-5 w-5 flex-shrik-0 mr-2' />
                                Dashboard
                            </NavLink>

                            <NavLink exact to="/JobListings" className='active w-full flex items-center px-4 py-2.5 text-lg font-bold text-[#067FB9] hover:bg-[#067FB9] hover:text-white rounded-xl focus:bg-[#067FB9] focus:text-white transition-all duration-200  group'>
