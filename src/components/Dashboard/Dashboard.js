                ...
                <div id='navigation' className='flex flex-col flex-1 px-4 mt-1'>
                    <div className='space-y-4'>
                        <nav id='main-menu' className='flex-1 space-y-2 translate-y-[-5rem]'>
                            ...
                            <button className='flex items-center px-4 py-2.5 text-lg font-bold text-[#1CA9EE] hover:bg-[#1CA9EE] hover:text-white rounded-xl focus:bg-[#1CA9EE] focus:text-white transition-all duration-200 group'>
                        ...
                        <div className='pb-3 mt-20 fixed bottom-0'>
                            <button className='flex items-center justify-center text-center align-center w-full px-4 py-3 text-lg font-medium -text-gray-900 hover:bg-gray-200 hover:rounded-xl hover:p-5 transition-all duration-100'>
