            ...
            <nav>
                <div className="flex flex-wrap justify-between items-center m-7 pt-[1.rem]">
                    ...
                    <div className="flex items-center">
                        ...
                        <ThemeSwitch />
                        {/* Bell Icon */}
                        <a href="#" className="flex items-center justify-center h-12 w-12 ml-4 rounded-full bg-white border-2 border-[#067FB9] hover:shadow-md transition duration-500 hover:translate-y-[-.4rem]">
                        ...
                        {/* Messages Button */}
                        <button className="flex items-center justify-center h-12 ml-4 px-2 rounded-full bg-white text-[#067FB9] border-2 border-[#067FB9] hover:shadow-md transition duration-500 hover:translate-y-[-.4rem]">
                            {/* Message Icon */}
